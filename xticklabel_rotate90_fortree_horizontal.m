function xticklabel_rotate90_fortree_horizontal(XTick,xTickLabels,rotangle,varargin)
...
%    newxticks=[1960:2:2004].';
%    xticklabel_rotate90(newxticks,cellstr(num2str(newxticks)));
%    %If you wish, you may set a few text "Property-value" pairs
%    xticklabel_rotate90(newxticks,cellstr(num2str(newxticks)),'Color','m','Fontweight','bold');
%
...
% Revised by Chen Song. 2013-7-9, under MATLAB 7.12.0
...
hText = text(XTick, y, xTickLabels,'fontsize',fs,'fontname','Arial');

% Rotate the text objects by 90 degrees
set(hText,'Rotation',rotangle,'HorizontalAlignment','right',varargin{:})
